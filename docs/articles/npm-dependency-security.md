# 我本地没问题，却造出了现网事故 —— 依赖安全三道防线

![依赖安全封面图](images/dependency-security-cover.jpg)

> **灵魂三问:**
>
> - **本地能跑，CI 炸了** —— 依赖悄悄从 `4.17.21` 升到 `4.17.22`，现网炸了，你还在排查本地代码？
> - **同一份代码，他能跑你不能跑** —— Node、pnpm 版本都对，最后发现是 lockfile 解析逻辑不一样？
> - **lockfile 冲突不敢合并** —— 看着几百行 `<<<<<<<`，手改怕错，重装又怕丢版本？
>
> ⭐ [如果这篇文章帮到你了,给个 Star 吧](https://github.com/Lycorxy/pvm) | 💬 [评论区聊聊你踩过的依赖坑](#评论区)
>
> 接下来,我会用 **3 个真实案例 + 3 道防线**,告诉你:**如何让依赖永不漂移,今天能跑的代码,明天也能跑。**
